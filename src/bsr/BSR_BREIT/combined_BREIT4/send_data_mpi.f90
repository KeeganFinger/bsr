...
! ... Send outer loop info (suffix 1)
      Call MPI_SEND(kt1,1,MPI_INTEGER,process,0,MPI_COMM_WORLD,ierr)
      ...
      Call MPI_SEND(C_det1,kt1*kdt1,MPI_DOUBLE_PRECISION,process,0,MPI_COMM_WORLD,ierr)

! ... Send inner loop info (suffix 2)
      Call MPI_SEND(kt2,1,MPI_INTEGER,process,0,MPI_COMM_WORLD,ierr)
      ...
      Call MPI_SEND(C_det2,kt2*kdt2,MPI_DOUBLE_PRECISION,process,0,MPI_COMM_WORLD,ierr)
